  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Obx(() {
          final channelName =
              controller.channels.firstWhereOrNull(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => controller.fetchPlaylistsByChannel(
      ...
      body: Obx(() {
        ...
        if (controller.playlists.isEmpty)
          return const Center(child: Text('Không có playlist'));
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return InfoCard(
              ...
              infoPairs:
                  infoPairs, // Sẽ null/empty → không render _InfoRow nếu không có
              leading: ClipRRect(
              ...
              onTap: () {
                controller.changePlaylist(
                  playlist.id,
                ); // Fetch videos của playlist
                context.push(
                  '/youtube/videos',
                ); // Go to VideosScreen với playlist
              },
              trailing: const Icon(
