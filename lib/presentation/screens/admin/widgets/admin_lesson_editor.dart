...
class AdminLessonEditor extends ChangeNotifier {
  AdminLessonEditor({required AdminController controller})
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButtonFormField<int>(
              value:
                  int.tryParse(controllers['correctIndex']?.text ?? '0') ?? 0,
              decoration: const InputDecoration(
  ...
  Future<void> showEditDialog(BuildContext context, LessonModel lesson) async {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Form(
          key: formKey,
          child: SingleChildScrollView(child: _buildBasicInfoFields()),
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
  ...
  Future<void> editLesson(
    ...
    try {
      ...
      await _controller.updateLesson(lessonId, updateData);
  ...
  Future<void> deleteLesson(BuildContext context, String lessonId) async {
    ...
    try {
      ...
      // Delete lesson
      await _controller.deleteLesson(lessonId);
